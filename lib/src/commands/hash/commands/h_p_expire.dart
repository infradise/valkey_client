...
extension HPExpireCommand on HashCommands {
  /// HPEXPIRE key milliseconds [NX | XX | GT | LT] FIELDS numfields field
  /// [field ...]
  ///
  /// Set an expiration (TTL) in [milliseconds] for one or more [fields] in
  ...
  /// - 2 if the field exists but has no associated expiration (when checking
  /// expiration).
  Future<List<int>> hPExpire(
    ...
    final cmd = <String>['HPEXPIRE', key, milliseconds.toString()];
