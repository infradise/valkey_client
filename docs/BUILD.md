...
```yaml
# version: 2.4.0  # Previous version
version: 2.4.1   # New version
```
...
Create a new release on GitHub. Use the tag you just created (e.g., `v2.4.1`). Copy the relevant section from `CHANGELOG.md` into the release notes.
