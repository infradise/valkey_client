...
```yaml
# version: 2.4.1  # Previous version
...
Create a new release on GitHub. Use the tag you just created (e.g., `v2.5.0`). Copy the relevant section from `CHANGELOG.md` into the release notes.
