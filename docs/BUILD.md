...
```yaml
# version: 2.5.4  # Previous version
version: 2.5.5   # New version
```
...
Create a new release on GitHub. Use the tag you just created (e.g., `v2.5.5`). Copy the relevant section from `CHANGELOG.md` into the release notes.
