...
```yaml
# version: 2.5.1  # Previous version
version: 2.5.2   # New version
```
...
Create a new release on GitHub. Use the tag you just created (e.g., `v2.5.2`). Copy the relevant section from `CHANGELOG.md` into the release notes.
