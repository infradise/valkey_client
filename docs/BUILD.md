...
```yaml
# version: 2.3.0  # Previous version
...
Create a new release on GitHub. Use the tag you just created (e.g., `v2.4.0`). Copy the relevant section from `CHANGELOG.md` into the release notes.
