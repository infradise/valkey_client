...
```yaml
# version: 2.5.5  # Previous version
...
Create a new release on GitHub. Use the tag you just created (e.g., `v3.0.0`). Copy the relevant section from `CHANGELOG.md` into the release notes.
